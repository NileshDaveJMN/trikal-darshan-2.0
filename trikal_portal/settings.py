...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-_(1@ran2op0v^mhq@2zun67n$3&*9+t8gfvv(ayi_5%(q4%*yi')
...
# Pydroid (mobile) pe SQLite, Render pe Neon PostgreSQL
